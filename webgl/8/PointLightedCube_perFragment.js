...
const main = () => {
  const vertexSource = /*glsl*/ `
    ...
    void main() {
      ...
      v_Position = u_ModalMatrix * v_Position;
      v_Color = a_Color;
  ...
  const uModalMatrix = gl.getUniformLocation(program, 'u_ModalMatrix');
  ...
  const loop = () => {
    ...
    gl.uniformMatrix4fv(uModalMatrix, false, modalMatrix.elements);
